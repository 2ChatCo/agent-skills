...
### Option B — Claude Code (local clone)
...
### Option C — Claude Desktop / Cowork (.plugin file)

1. Download the packaged `2chat-sales-service-plugin.plugin` file from this repo's [Releases](../../releases) page (or build it yourself — see below).
